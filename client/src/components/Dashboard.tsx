		...
		<div className="container-fluid" style={{height: "100vh"}}>
			<div className="row" style={{height: "10%", paddingTop: "2%"}}>
				<div className="col-sm-3">
					<div className="container" style={{marginLeft: "5%"}}>
						<div className="input-group mb-3">
							<input type="text" disabled={!viewerInitialized} className="form-control" id="modelUrn" placeholder="Model URN" aria-label="ModelUrn" aria-describedby="basic-addon2" />
							<div className="input-group-append">
								<button disabled={!viewerInitialized} className="btn btn-outline-primary" type="button" onClick={() => handleModelChange()}>
									Change
								</button>
							</div>
						</div>
				...
				<div className="col-sm-5">
					<h1 className="h3" style={{textDecoration: "underline", textDecorationColor: "#0080ff", color: "#3c414f"}}>
